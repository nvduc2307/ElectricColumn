namespace CadDev.Extension.CustomAttribute
{
    ...
    public class RibbonToggleButtonAttribute(string ribbonTitle, string ribbonPanel, string commandName, string description, string image = "", string largeImage = "") : Attribute
    {
